      ...
      <Row style={{ textAlign: 'center' }}>
        <Col>
          <EmptyButton
            ...
            styles={{
              padding: '2% 10%',
              border: '3px solid rgba(0, 155, 120, 0.8)',
              backgroundColor: 'white',
              boxShadow: 'none',
              color: '#009B78'
            }}
        ...
        <Col>
          <EmptyButton
            ...
            styles={{
              padding: '2% 10%',
              border: '3px solid rgba(253, 216, 7, 0.8)',
              backgroundColor: 'white',
              boxShadow: 'none',
              color: '#DBC54A'
            }}
        ...
        <Col>
          <EmptyButton
            ...
            styles={{
              padding: '2% 10%',
              border: '3px solid rgba(39, 39, 38, 0.8)',
              backgroundColor: 'white',
              boxShadow: 'none',
              color: '#272726'
            }}
        ...
        <Col>
          <BlockButton
            ...
            styles={{
              borderStyle: 'none',
              background:
                'radial-gradient(50% 50% at 50% 50%, #009B78 0%, #357B6B 100%)',
              boxShadow: 'none',
              color: '#FFFFFF'
            }}
            text="Green Block Button"
          />
        </Col>
        <Col>
          <BlockButton
            ...
            styles={{
              borderStyle: 'none',
              background:
                'radial-gradient(50% 50% at 50% 50%, #FDD807 0%, #FBBC05 100%)',
              boxShadow: 'none',
              color: '#FFFFFF'
            }}
            text="Yellow BLock Button"
          />
        </Col>
      </Row>
      <br />
