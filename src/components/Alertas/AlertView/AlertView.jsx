...
export default function AlertView() {
  ...
  function mostrarHandle(valor) {
    // funcion que recibe el valor de mostrar desde el componente modal -> que deberia ser un falso
    setMostrar(valor) // setea el falso
  }

  function firstClick() {
    // cambia el mostrar a true para que el modal se active
    setMostrar(true)
  }
  return (
      ...
      <Row>
        <Col>
          <Button
            variant="btn-filled"
            text="Clickeame"
            styles={{ backgroundColor: '#009B78', color: '#FFFFFF' }}
            onClickProp={firstClick}
          />
          <GreenAlert mostrar={mostrar} getOpen={mostrarHandle} />
        </Col>
        <Col>
          <Alerta2
            text="Debe ingresar con una cuenta de Spread"
