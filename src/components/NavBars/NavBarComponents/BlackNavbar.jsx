...
export default function BlackNavbar({title,titleHref,items,dpItems,separatedLink}) {
                    ...
                    <div className="dropdown-menu black-dropdown-menu">
                        {
                            dpItems.map( (elemento) => {
                                return(
                                    <a key={elemento.href_label} className="dropdown-item black-dropdown-item" href={elemento.href}>{elemento.href_label}</a>
                                )
                            } )
                        }
                        <div className="dropdown-divider"></div>
                        <a className="dropdown-item black-dropdown-item" href="/">Separated link</a>
                    </div>
                </li>
