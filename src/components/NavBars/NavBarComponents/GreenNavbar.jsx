...
function GreenNavbar({ title, titleHref, items, dpItems }) {
          ...
          <ul
            ...
            <li className="nav-item dropdown ">
              ...
              <div className="dropdown-menu green-dropdown-menu">
                {dpItems.map(elemento => {
                  return (
                    <a
                      ...
                      className="dropdown-item green-dropdown-item"
                      href={elemento.href}>
                      {elemento.href_label}
                    </a>
                  )
                ...
                <a className="dropdown-item green-dropdown-item" href="/">
                  Separated link
                </a>
              </div>
            </li>
