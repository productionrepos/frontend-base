...
export const Header = () => {
  ...
  const dpItems = [
    ...
    },
    {
      href: '/Alerts',
      href_label:
        'Alerts \xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0'
    },
    {
      href: '/Forms',
      href_label: 'Forms'
      ...
      <div className="container-fluid">
        <a className="navbar-brand name" href="/Home">
          <img
            src={title}
            alt="img-title"
            style={{ height: '40px', paddingLeft: '40%' }}
          />
        </a>
        <button
